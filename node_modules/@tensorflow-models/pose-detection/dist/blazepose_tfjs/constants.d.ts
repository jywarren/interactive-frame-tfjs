...
export declare const DEFAULT_BLAZEPOSE_DETECTOR_MODEL_URL = "https://tfhub.dev/mediapipe/tfjs-model/blazeposedetector/1/default/1";
export declare const DEFAULT_BLAZEPOSE_LANDMARK_MODEL_URL_FULL = "https://tfhub.dev/mediapipe/tfjs-model/blazeposelandmark_full/1/default/1";
export declare const DEFAULT_BLAZEPOSE_LANDMARK_MODEL_URL_LITE = "https://tfhub.dev/mediapipe/tfjs-model/blazeposelandmark_lite/1/default/1";
export declare const DEFAULT_BLAZEPOSE_LANDMARK_MODEL_URL_HEAVY = "https://tfhub.dev/mediapipe/tfjs-model/blazeposelandmark_heavy/1/default/1";
...
export declare const BLAZEPOSE_DETECTOR_IMAGE_TO_TENSOR_CONFIG: {
    inputResolution: {
        width: number;
        height: number;
    };
...
export declare const BLAZEPOSE_LANDMARK_IMAGE_TO_TENSOR_CONFIG: {
    inputResolution: {
        width: number;
        height: number;
    };
...
export declare const BLAZEPOSE_TENSORS_TO_LANDMARKS_CONFIG: {
    numLandmarks: number;
