...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@mediapipe/pose'), require('@tensorflow/tfjs-converter'), require('@tensorflow/tfjs-core')) :
    typeof define === 'function' && define.amd ? define(['exports', '@mediapipe/pose', '@tensorflow/tfjs-converter', '@tensorflow/tfjs-core'], factory) :
    (global = global || self, factory(global.poseDetection = {}, global.Pose, global.tf, global.tf));
}(this, (function (exports, pose, tfconv, tf) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function convertImageToTensor(image, config, normRect) {
        ...
        var padding = padRoi(roi, inputResolution, keepAspectRatio);
        var imageTensor = tf.tidy(function () {
            var $image = toImageTensor(image);
            var transformMatrix = tf.tensor2d(getProjectiveTransformMatrix(roi, imageSize, false, inputResolution), [1, 8]);
    ...
    function detectorInference(imageTensor, poseDetectorModel) {
        return tf.tidy(function () {
            ...
            var _a = splitDetectionResult(detectionResult), scores = _a[0], rawBoxes = _a[1];
            // Shape [896, 12]
     ...
     * =============================================================================
     */
    var DEFAULT_BLAZEPOSE_DETECTOR_MODEL_URL = 'https://tfhub.dev/mediapipe/tfjs-model/blazeposedetector/1/default/1';
    var DEFAULT_BLAZEPOSE_LANDMARK_MODEL_URL_FULL = 'https://tfhub.dev/mediapipe/tfjs-model/blazeposelandmark_full/1/default/1';
    var DEFAULT_BLAZEPOSE_LANDMARK_MODEL_URL_LITE = 'https://tfhub.dev/mediapipe/tfjs-model/blazeposelandmark_lite/1/default/1';
    var DEFAULT_BLAZEPOSE_LANDMARK_MODEL_URL_HEAVY = 'https://tfhub.dev/mediapipe/tfjs-model/blazeposelandmark_heavy/1/default/1';
        ...
        BlazePoseTfjsDetector.prototype.detectPose = function (image) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            _a = convertImageToTensor(image, BLAZEPOSE_DETECTOR_IMAGE_TO_TENSOR_CONFIG), imageTensor = _a.imageTensor, padding = _a.padding;
                            imageValueShifted = shiftImageValue(imageTensor, [-1, 1]);
                            _b = detectorInference(imageValueShifted, this.detectorModel), boxes = _b.boxes, scores = _b.scores;
                            return [4 /*yield*/, tensorsToDetections([scores, boxes], this.anchorTensor, BLAZEPOSE_TENSORS_TO_DETECTION_CONFIGURATION)];
                        case 1:
                            detections = _c.sent();
                            return [4 /*yield*/, nonMaxSuppression(detections, this.maxPoses, BLAZEPOSE_DETECTOR_NON_MAX_SUPPRESSION_CONFIGURATION
                                    .minSuppressionThreshold, BLAZEPOSE_DETECTOR_NON_MAX_SUPPRESSION_CONFIGURATION
                                    .minScoreThreshold)];
                        case 2:
        ...
        BlazePoseTfjsDetector.prototype.poseLandmarksByRoi = function (poseRect, image) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = convertImageToTensor(image, BLAZEPOSE_LANDMARK_IMAGE_TO_TENSOR_CONFIG, poseRect), imageTensor = _a.imageTensor, padding = _a.padding;
                            imageValueShifted = shiftImageValue(imageTensor, [0, 1]);
                        ...
                        case 2:
                            landmarks = _b.sent();
                            return [4 /*yield*/, refineLandmarksFromHeatmap(landmarks, heatmapTensor, BLAZEPOSE_REFINE_LANDMARKS_FROM_HEATMAP_CONFIG)];
                        case 3:
                            refinedLandmarks = _b.sent();
                            adjustedLandmarks = removeLandmarkLetterbox(refinedLandmarks, padding);
                            landmarksProjected = calculateLandmarkProjection(adjustedLandmarks, poseRect);
                            actualLandmarks = landmarksProjected.slice(0, BLAZEPOSE_NUM_KEYPOINTS);
                            auxiliaryLandmarks = landmarksProjected.slice(BLAZEPOSE_NUM_KEYPOINTS, BLAZEPOSE_NUM_AUXILIARY_KEYPOINTS);
                            tf.dispose(landmarkResult);
                            tf.dispose([imageTensor, imageValueShifted]);
    ...
    var VALID_MODELS = [SINGLEPOSE_LIGHTNING, SINGLEPOSE_THUNDER];
    var MOVENET_SINGLEPOSE_LIGHTNING_URL = 'https://tfhub.dev/google/tfjs-model/movenet/singlepose/lightning/3';
    var MOVENET_SINGLEPOSE_THUNDER_URL = 'https://tfhub.dev/google/tfjs-model/movenet/singlepose/thunder/3';
    ...
    var MOVENET_SINGLE_POSE_ESTIMATION_CONFIG = {
        maxPoses: 1
    };
    ...
    function validateEstimationConfig$1(estimationConfig) {
        var config = estimationConfig == null ?
            MOVENET_SINGLE_POSE_ESTIMATION_CONFIG : __assign({}, estimationConfig);
        if (!config.maxPoses) {
            config.maxPoses = 1;
        }
    ...
    var MoveNetDetector = /** @class */ (function () {
        function MoveNetDetector(moveNetModel, config) {
            ...
            // Global states.
            this.keypointsFilter = new KeypointsOneEuroFilter(KEYPOINT_FILTER_CONFIG);
        ...
        MoveNetDetector.prototype.estimatePoses = function (image, estimationConfig, timestamp) {
            if (estimationConfig === void 0) { estimationConfig = MOVENET_SINGLE_POSE_ESTIMATION_CONFIG; }
            return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, tfconv.loadGraphModel(config.modelUrl)];
                    case 1:
                        model = _a.sent();
                        return [3 /*break*/, 4];
                    case 2:
                        ...
                        return [4 /*yield*/, tfconv.loadGraphModel(modelUrl, { fromTFHub: true })];
                    case 3:
                        model = _a.sent();
                        _a.label = 4;
    ...
    function validateEstimationConfig$2(estimationConfig) {
        ...
        if (config.maxPoses > 1) {
            ...
            // parameters.
            config = __assign({}, MULTI_PERSON_ESTIMATION_CONFIG, config);
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            this.maxPoses = config.maxPoses;
                            _a = convertImageToTensor(image, { inputResolution: this.inputResolution, keepAspectRatio: true }), imageTensor = _a.imageTensor, padding = _a.padding;
